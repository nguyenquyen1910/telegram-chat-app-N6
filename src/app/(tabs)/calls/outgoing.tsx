...
export default function OutgoingCallScreen() {
  ...
  const gradColors: [string, string, string] = isActive
    ? ["#1E6B5B", "#2D8B6A", "#4BA882"]
    : ["#5B57A2", "#7A66C8", "#9B84E0"];

  const rippleColor = isActive ? "rgba(100,220,170,0.45)" : "rgba(160,140,230,0.45)";
